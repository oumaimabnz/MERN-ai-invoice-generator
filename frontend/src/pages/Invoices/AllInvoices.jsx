...
import { Plus, Trash2, Edit, Search, FileText, AlertCircle, Sparkles, Mail, Loader2} from "lucide-react"
...
const AllInvoices = () => {
  ...
  const filteredInvoices = useMemo(() => {
    return invoices
      ...
      .filter(invoice =>
        invoice.invoiceNumber.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
        ...
        <div className='p-4 sm:p-6 border-b border-slate-200'>
          <div className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='shrink-0'>
              <select 
                className='w-full sm:w-auto h-10 px-3 py-2 border-slate-200 rounded-lg bg-white text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500'
                value={statusFilter}
