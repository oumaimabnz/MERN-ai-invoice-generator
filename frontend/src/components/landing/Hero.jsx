  ...
  return ( <section className="relative bg-[#fbfbfb] overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-xl text-gray-700 mb-8 leading-relaxed mx-w-3xl mx-auto">
                Let our AI create invoices from simple text, generate payments reminders, and provide smart insights to help you manage ypur finances.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a href="#features" className="border-2 border-black text-black px-8 py-4 rounded-xl font-bold sm:text-lg hover:bg-white hover:text-black transition-all duration-200 hover:scale-105">
                    Learn More
                </a>
            </div>
        </div>
